...
#define     SHELL_SUPPORT_USER          0

/**
 * @brief 是否在输出命令列表中列出变量
 */
#define     SHELL_HELP_LIST_VAR         0
#define     SHELL_SUPPORT_VAR           0

/**
 * @brief 是否在输出命令列表中列出按键
 */
#define     SHELL_HELP_LIST_KEY         0
#define     SHELL_SUPPORT_KEY           0

/**
 * @brief 是否在输出命令列表中展示命令权限
 */
#define     SHELL_HELP_SHOW_PERMISSION  0
#define     SHELL_SUPPORT_PERMISSION    0

#define     SHELL_HELP_LIST_MSG         0
#define     SHELL_SUPPORT_MSG           1
 ...
 * @brief 历史命令记录数量
 */
#define     SHELL_HISTORY_MAX_NUMBER    2
