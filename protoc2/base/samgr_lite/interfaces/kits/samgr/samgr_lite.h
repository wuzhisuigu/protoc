...
#define MAX_SYSCAP_NAME_LEN 64
    ...
    typedef struct SamgrLite
    {
        ...
        (const char *serviceName, Feature *feature);
         ...
         * @version 1.0
         */
        BOOL (*RegisterDefaultFeatureApi)
        (const char *service, IUnknown *publicApi);
         ...
         * @version 1.0
         */
        BOOL (*RegisterFeatureApi)
        (const char *service, const char *feature, IUnknown *publicApi);
        ...
        BOOL (*GetServiceId)
        (const char *serviceName, Identity *id);
        BOOL (*GetFeatureId)
        (const char *serviceName, const char *feature, Identity *id);
