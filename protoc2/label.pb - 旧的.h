...
const std::string& Label_DataSetType_Name(Label_DataSetType value);
template<typename T>
inline const std::string& Label_DataSetType_Name(T enum_t_value) {
  ...
  return Label_DataSetType_Name(static_cast<Label_DataSetType>(enum_t_value));
}
...
class Point2f final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:cf.glacier.Point2f) */ {
 public:
...
class Size2f final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:cf.glacier.Size2f) */ {
 public:
...
class KeyPoint final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:cf.glacier.KeyPoint) */ {
 public:
...
class Ring final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:cf.glacier.Ring) */ {
 public:
...
class Polygon final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:cf.glacier.Polygon) */ {
 public:
...
class Region final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:cf.glacier.Region) */ {
 public:
...
class Label final :
    public ::PROTOBUF_NAMESPACE_ID::MessageLite /* @@protoc_insertion_point(class_definition:cf.glacier.Label) */ {
 public:
